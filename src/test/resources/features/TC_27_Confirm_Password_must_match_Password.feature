...
Feature:Register Panel
  Scenario Outline: Kayıt işleminde password ile confirm password alanları eşit olmadığı taktirde kayıt olunmaya çalışılması  engelenmeli
    ...
    Then Passwords does not match!! uyarısı alındığını doğrula



    Examples:
      | firstName | lastName | country | mobileNumber | company       | email              |  title                   |   password         |  confirmPassword |
      | Nur       | Test     | +90     | 5555555555   | Test Company  | hnk9833@gmail.com  |  Logistic Manager        |   Pass123!         |  Pass127!        |
