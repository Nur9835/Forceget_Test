...
Feature:Register Panel
  Scenario Outline: Kayıt işleminde firstname alanında tek harfli kayıt yapılmasına izin vermemeli
    ...
    Examples:
      ...
      | N         | Test     | +90     | 5555555555   | Test Company  | hnk9833@gmail.com  |  Logistic Manager        |   Pass123!         |  Pass123!        |
