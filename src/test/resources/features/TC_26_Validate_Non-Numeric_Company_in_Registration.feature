...
Feature:Register Panel
  Scenario Outline: Kayıt işleminde company alanında numeric değerle kayıt yapılmasına izin vermemeli
    ...
    Examples:
      ...
      | Nur       | Test     | +90     | 5555555555   | 89074         | hnk9833@gmail.com  |  Logistic Manager        |   Pass123!         |  Pass123!        |
