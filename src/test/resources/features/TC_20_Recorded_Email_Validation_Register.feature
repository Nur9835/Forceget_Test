...
Feature:Register Panel
  Scenario Outline: Kayıt işleminde önceden kayıt olunmuş e-mail ile tekrar kayıt olunmaya çalışılması durumunda Bu e-posta zaten bir hesapla ilişkilendirilmiş. Lütfen farklı bir e-posta kullanın veya giriş yapın uyarısını vermeli
    ...
    Examples:
      ...
      | Nur       | Test     | +90     | 5555555555   | Test Company  | testnur9@gmail.com  |  Logistic Manager        |   Pass123!         |  Pass123!        |
