...
Feature:Register Panel
  Scenario Outline: Kayıt işleminde company alanında tek harfli kayıt yapılmasına izin vermemeli
    ...
    Examples:
      ...
      | Nur       | Test     | +90     | 5555555555   | T             | hnk9833@gmail.com  |  Logistic Manager        |   Pass123!         |  Pass123!        |
